...
export interface cc {
  ...
  each<T>(
    ...
    iterator: (
      value: unknown,
      index: T extends Array<unknown> ? number : string
    ) => boolean,
    context?: unknown
  ): void;
   ...
   */
  sequence(
    tempArray: CCFiniteTimeAction | CCFiniteTimeAction[],
    actionTwo?: CCFiniteTimeAction
  ): CCSequence;
