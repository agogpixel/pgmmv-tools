...
export interface DirectionMove {
  ...
  /**
   * Value -2 or 1+. WARNING: If the value is 0 or a number outside the number of directions you have in your motion, the game will crash. This is of particular interest if you are using this to move another object
  ...
  /**
   * Value any whole number. Distance to move (in pixels) and only works if moveDistanceEnabled is true. NOTE: If you put decimals, the value will round down to the nearest whole number.
   */
  moveDistance: number;
